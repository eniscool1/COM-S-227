...
//		grid.setTile(new Tile(1), 1, 1);
		...
		ConnectGame game = new ConnectGame(4, 4, 1, 4, new Random(0));
		...
		Tile t1 = grid.getTile(0, 0);
		Tile t2 = grid.getTile(0, 2);
		System.out.println(game.isAdjacent(t1,t2));
		
		Tile t3 = grid.getTile(0, 0);
		Tile t4 = grid.getTile(1, 0);
		System.out.println(game.isAdjacent(t3,t4));
...
//		System.out.println(game.getSelectedAsArray().length);
//
...
//		System.out.println(game.getGrid().getTile(0, 1).isSelected());
